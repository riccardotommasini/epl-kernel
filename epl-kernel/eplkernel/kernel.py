...
from .connection import EPLConnection, KrnlException, magics, magic_help
...
class EPLKernel(Kernel):
    ...
    language_info = { 'name': 'epl', 
                      'mimetype': 'application/json',
                      'codemirror_mode':  { "name": "epl" },
    ...
    help_links = List([
        {
            'text': "EPL",
            'url': "http://esper.espertech.com/release-7.1.0/esper-reference/html/index.html",
        },
        {
            'text': "EPL Tutorial",
            'url': "http://esper.espertech.com/release-7.1.0/esper-reference/html/processingmodel.html",
        },])
    ...
    def __init__(self, **kwargs):
        ...
        super(EPLKernel, self).__init__(**kwargs)
    ...
    def _send( self, data, msg_type='ok', silent=False ):
        ...
        """
        # Data to send back
        self._klog.info("SEND")
        self._klog.info(data)
    ...
    def do_execute( self, code, silent, store_history=True,
        ...
        try:
            ...
            self._klog.info(result)

            # Return the result
            return self._send(result, 'raw', silent=silent )

        except Exception as e:
            self._klog.info("Exception")
...
if __name__ == '__main__':
    ...
    IPKernelApp.launch_instance( kernel_class=EPLKernel )
