...
class EPLKernelInstall( InstallKernelSpec ):
    """
    ...
    description = '''Install the EPL Jupyter Kernel.
    ...
    aliases =  { 'logdir' : 'EPLKernelInstall.logdir' } 
 ...
 the other.")
        ...
        self.log.info('Installing EPL kernel')
...
class EPLKernelRemove( RemoveKernelSpec ):
    """
    The kernel uninstallation class
    """

    spec_names = [ KERNEL_NAME ]
    description = '''Remove the EPL Jupyter Kernel'''
    ...
    def start(self):
        ...
        super(EPLKernelRemove, self).start()
