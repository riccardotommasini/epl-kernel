...
from eplkernel.constants import __version__, LANGUAGE, DISPLAY_NAME


PKGNAME = 'eplkernel'
GITHUB_URL = 'https://github.com/riccardotommasini/epl-kernel'
...
#        'Diagram': [ 'graphviz' ] },
    ...
    entry_points = { 
        'console_scripts': 
        [ 'jupyter-eplkernel = eplkernel.__main__:main'],
        'pygments.lexers' :
        ['sparql_with_magic = eplkernel.pygments_sparql:SparqlLexerMagics']
    },
